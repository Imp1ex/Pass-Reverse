...
from pass_reverse.verification.utils.core import process_captcha_authentication, initialize_session
...
def sms_authentication(cp_data_url, isp, name, birthdate, jumin, phone, captcha_mode='auto',
