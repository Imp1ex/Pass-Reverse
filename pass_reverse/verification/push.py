...
from pass_reverse.verification.utils.core import process_captcha_authentication, initialize_session, wait_for_confirm
...
def push_authentication(cp_data_url, isp, name, phone, captcha_mode='auto',
